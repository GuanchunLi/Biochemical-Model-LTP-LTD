...
for k = 1:length(dt_lst)
    dt = dt_lst(k);
    [t_Ca_lst, Ca_lst, Ca_sys_lst] = run_simulation_k(tk_pre_lst, tk_pre_center, t_end, dt_lst(k), k, paras);
...
function [t_Ca_lst, Ca_lst, Ca_sys_lst] = run_simulation_k(tk_pre_lst, tk_pre_center, t_end, dt, k, paras)
