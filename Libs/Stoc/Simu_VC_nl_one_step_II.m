function [t_new, y_VC_new, n_channels_new, R_channels_new] = ...
    Simu_VC_nl_one_step_II(t, y_VC, n_channels, R_channels, I_stim, dt, NMDA_factor, CaV_factor)
...
[y_VC_new_temp, dy_VC] = Update_VC_II(y_VC, n_channels, I_stim, dt, NMDA_factor, CaV_factor);
Vs_new = y_VC_new_temp(1);
c_Ca_SS_new = y_VC_new_temp(3);
[R_channels_new_temp] = Rate_Channels_II(t+dt, n_channels, Vs_new, c_Ca_SS_new);
...
Update_VC_family_II(t, y_VC, n_channels, dt, ...
