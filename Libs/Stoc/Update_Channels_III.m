function [n_channels_new] = Update_Channels_III(n_channels, i_channels)
% The reaction scheme for the CaMKII subunits with neighboring
% phosphorylation (Stochastic version)
% INPUTS:
%        n_channels -- 1 a 22*1 array (number of channels different states)
%        i_channels -- 1 index of the next reaction (1<=i_channels<=50)
% OUTPUTS:
%        n_channels_new -- 1 a 22*1 array
