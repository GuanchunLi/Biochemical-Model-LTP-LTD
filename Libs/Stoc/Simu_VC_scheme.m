function [t_lst, y_VC_lst, n_channels_lst] = ...
    Simu_VC_scheme(t_start, t_end, y_VC_0, n_channels_0, dt0, I_stim_func, NMDA_factor, CaV_factor)
% SIMU_STOCH_SCHEME
...
while t < t_end
    ...
    Simu_VC_nl_one_step(t, y_VC, n_channels, R_channels, I_stim_func(t), dt, NMDA_factor(t), CaV_factor(t));
