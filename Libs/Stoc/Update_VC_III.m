function [y_VC_new, dy_VC] = Update_VC_III(y_VC, n_channels, I_stim, dt, NMDA_factor, CaV_factor)
...
s_Na = y_VC(4:5);
s_K = y_VC(6);
y_CaV12 = y_VC(7:12);  % Variables of CaV12 model
y_CaV13 = y_VC(13:18); % Variables of CaV13 model
...
dy_VC(4:5) = ds_Na;
dy_VC(6) = ds_K;
dy_VC(7:12) = dy_CaV12; % Variables of CaV12 model
dy_VC(13:18) = dy_CaV13; % Variables of CaV13 model
