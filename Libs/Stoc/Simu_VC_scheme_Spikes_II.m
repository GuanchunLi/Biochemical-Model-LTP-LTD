...
[t_lst, y_VC_lst, n_channels_lst] = ...
    Simu_VC_scheme_II(t_start_0, t_end_0, y_VC_0, n_channels_0, dt0, I_stim_func, NMDA_factor, CaV_factor);
...
for i = 1:(length(tk_pre_lst)-1)
    ...
    Simu_VC_scheme_II(t_start_i, t_end_i, y_VC, n_channels, dt0, I_stim_func, NMDA_factor, CaV_factor);
