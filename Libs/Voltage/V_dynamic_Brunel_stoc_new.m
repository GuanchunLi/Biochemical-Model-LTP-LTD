function [dy_cir, J_Ca, J_CaV, J_NMDA] = V_dynamic_Brunel_stoc_new(y_cir, x_AMPA, x_NMDA, I_stim, NMDA_factor, CaV_factor)
...
g_CaV12 = 82; %  40, 182 mmol/(cm C) Strength of Ca current flux due to CaV12
g_CaV13 = 20;  %  100, 20 mmol/(cm C) Strength of Ca current flux
...
beta_CaV = 1e-1; % 1 Buffer factor for CaV Ca current
...
J_Ca_12 = CaV_flux(Po_CaV12, g_CaV12, c_Ca, Vs) * CaV_factor;
J_Ca_13 = CaV_flux(Po_CaV13, g_CaV13, c_Ca, Vs) * CaV_factor;
J_Ca_12_SS = CaV_flux(Po_CaV12, g_CaV12_SS, c_Ca, Vs) * CaV_factor;
...
J_CaV = (J_Ca_12 + J_Ca_13) * beta_CaV;
...
dy_CaV12 = CaV12(y_CaV12, c_Ca_SS, Vs);
dy_CaV13 = CaV13(y_CaV13, c_Ca_SS, Vs);

dCa = cs_dynamic_new(c_Ca, J_Ca);
