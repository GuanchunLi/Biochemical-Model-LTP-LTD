function [dV] = V_dynamic_newParam(V, I_AMPA, I_NMDA, I_CaV, I_stim, paras)
...
ratio_Cm = paras.ratio_Cm;

% Set the parameters
g_L = 3.5714 / ratio_Cm; %0.56e-3;   % nS  Maximum leak conductance
E_L = -70.33;  % mV Leak reversal potential making resting to be -70 mV (maybe change it later...)
