function [dy_cir, J_Ca, J_CaV12, J_CaV13, J_NMDA] = V_dynamic_Brunel_stoc_newParam(y_cir, x_AMPA, x_NMDA, I_stim, NMDA_factor, CaV_factor, paras)

ratio_Cm = paras.ratio_Cm; % Normalization factor for capacitance
...
g_Na = 0.56 * 1e3 / ratio_Cm; % nS Maximum sodium conductance
g_K = 1.0 * 1e3 / ratio_Cm; % nS Maximum potassium conductance
...
I_AMPA = AMPA_current(s_AMPA, Vs, paras);
...
% Compute the rates
dVs = V_dynamic_newParam(Vs, I_AMPA, I_NMDA, I_CaV, I_stim, paras);
