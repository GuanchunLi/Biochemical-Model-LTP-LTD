function [dy] = CaV13_model_Mahajan(y, Vs)
cp = y(1);
cs = y(2);
y_CaV13 = y(3:8);
...
J_Ca_12 = CaV_flux(Po_CaV13, g_CaV13, cs, Vs) * CaV_factor;
% J_Ca_13 = CaV_flux(Po_CaV13, g_CaV13, c_Ca, Vs) * CaV_factor;
J_Ca_12_SS = CaV_flux(Po_CaV13, g_CaV13_SS, cs, Vs) * CaV_factor;
...
dy_CaV13 = CaV13(y_CaV13, cp, Vs);

dy = [d_cp; d_cs; dy_CaV13];
end