...
Simu_Framework(t_end, tk_pre_lst, I_stim_func, t_cri_lst, paras, ...
...
if stoc_input_flag % Stochastic calcium input
    ...
    [t_lst, y_VC_lst, ~] = ...
        Simu_VC_scheme_Spikes_II(0, t_end, y_VC_0, n_channels_0, dt0, I_stim_func, NMDA_factor, CaV_factor, tk_pre_lst);
