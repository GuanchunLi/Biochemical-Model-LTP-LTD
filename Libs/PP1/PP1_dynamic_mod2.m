function [dy_PP1] = PP1_dynamic_mod2(t, y_PP1, c_Ca, p_E, p_EP, dE_CaM, c_CaM4_tot, paras)
...
dy_PP1(1) = - dy_PP1(2) + paras.alpha_P_auto * c_EP0 / (K_m50_EP + c_EP0) * c_E ...
          - c_E0/(c_E0 + K_m50_E) * Cdk5_a_Ca * paras.alpha_Cdk5 + dE_CaM - paras.r_P_base*c_E + paras.d_E_base;
