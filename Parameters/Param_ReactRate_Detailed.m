function [paras] = Param_ReactRate_Detailed(paras)
...
paras.alpha_E = 5*v; paras.beta_E = 1e0*v;
...
paras.alpha_AO = 20*v; paras.beta_AO = 1e0*v; % Cat-subunit is unphosphorylated
paras.alpha_AP = 20*v; paras.beta_AP = 1e0*v; % Cat-subunit is phosphorylated
